...
class SelecaoPaginadaTipoParametro extends SelecaoPaginada<TipoParametro>{
    ...
    async selecionar(repositorio: Repository<TipoParametro>, pagina: number, tamanhoPagina: number, filtro: InterfaceFiltroSelecao): Promise<TipoParametro[]> {
        ...
        .select(["tipo_parametro.idTipoParametro", "tipo_parametro.nomeTipoParametro", "tipo_parametro.fatorTipoParametro", "tipo_parametro.unidadeTipoParametro", "tipo_parametro.offsetTipoParametro"]) // Seleciona apenas os atributos desejados
